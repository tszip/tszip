...
exports.getNodeEngineRequirement = exports.getReactVersion = exports.clearConsole = exports.resolveApp = exports.appDirectory = exports.external = exports.EXTERNAL_PACKAGES = exports.safePackageName = exports.safeVariableName = exports.removeScope = void 0;
 ...
 */
exports.EXTERNAL_PACKAGES = ['react', 'react-native'];
/**
 * Mark EXTERNAL_PACKAGES and all relative imports as external.
 */
const external = (id) => exports.EXTERNAL_PACKAGES.includes(id) || (id.startsWith('.') && path_1.default.isAbsolute(id));
